	...
	prompt() {
		...
		for (let i = 0; i < inputs.length; i++) {
			...
			l.ondrop = event => {
				...
				//hier muss ueberprueft werden ob word complete ist!
				//oder ein Done button: besser wahrscheinlic!
			}
			// l.onmousedown = onMouseDownOnLetter; das ist damit man die inputs auch dd kann!
			makeDraggableInner(l);
