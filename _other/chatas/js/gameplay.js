...
function game_resume_or_start() {
	...
	let hmin=680;
	inner_left_panel.innerHTML = `<div style='min-height:${hmin}px'>
	...
	if (isEmpty(CURRENT_GAME)) CURRENT_GAME = U.lastGame; //'gSentence'; //for now: set game here if it wasnt set!
