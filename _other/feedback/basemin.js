...
function mAppear(d, ms = 800, callback = null, easing = 'ease') { return mAnimateTo(d, 'opacity', 1, callback, ms, easing); }
function mFade(d, ms = 800, callback = null, easing = 'ease') { return mAnimateTo(d, 'opacity', 0, callback, ms, easing); }
